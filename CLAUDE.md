...
- **SESSION_RUNNER.md documents 27 failure modes** with specific countermeasures. These are empirically derived from 1100+ sessions — do not remove or weaken them without strong justification. FMs 1–26 must not be renumbered; new FMs append at the end (e.g., FM #24 was appended in v2.3, FM #25 in v2.6, and FM #26 in v2.7; FM #27 was appended after these, not inserted).
