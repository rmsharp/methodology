#!/usr/bin/env bash
# Losslessness proof for docs/archive/CHANGELOG-through-2026-09-16.md — generated by methodology_trim.py v1.5.0.
#
...
LIVE=CHANGELOG.md
SHARD=docs/archive/CHANGELOG-through-2026-09-16.md
