#!/usr/bin/env bash
# Losslessness proof for docs/archive/CHANGELOG-through-2026-08-02.md — generated by methodology_trim.py v1.1.1.
#
...
LIVE=CHANGELOG.md
SHARD=docs/archive/CHANGELOG-through-2026-08-02.md
INJECTED=1
