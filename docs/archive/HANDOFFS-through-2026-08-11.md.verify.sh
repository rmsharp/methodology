#!/usr/bin/env bash
# Losslessness proof for docs/archive/HANDOFFS-through-2026-08-11.md — generated by methodology_trim.py v1.1.3.
#
...
LIVE=HANDOFFS.md
SHARD=docs/archive/HANDOFFS-through-2026-08-11.md
INJECTED=0
