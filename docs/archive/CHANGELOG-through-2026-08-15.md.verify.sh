#!/usr/bin/env bash
# Losslessness proof for docs/archive/CHANGELOG-through-2026-08-15.md — generated by methodology_trim.py v1.2.0.
#
...
LIVE=CHANGELOG.md
SHARD=docs/archive/CHANGELOG-through-2026-08-15.md
