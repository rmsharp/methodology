#!/usr/bin/env bash
# Losslessness proof for docs/archive/HANDOFFS-through-2026-09-20-5.md — generated by methodology_trim.py v1.5.0.
#
...
LIVE=HANDOFFS.md
SHARD=docs/archive/HANDOFFS-through-2026-09-20-5.md
