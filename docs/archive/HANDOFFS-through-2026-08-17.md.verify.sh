#!/usr/bin/env bash
# Losslessness proof for docs/archive/HANDOFFS-through-2026-08-17.md — generated by methodology_trim.py v1.2.0.
#
...
LIVE=HANDOFFS.md
SHARD=docs/archive/HANDOFFS-through-2026-08-17.md
