...
**Not posted.** Opening the PR, and pushing the branch to fork `origin` first, is P4's go-ahead on the exact text
below. Every figure in it was measured at S214 on the heads named in its first line; re-measure if either head
