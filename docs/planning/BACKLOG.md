...
| **BL-41** | `methodology_trim.py` cannot trim `HANDOFFS.md`: shard-naming-by-date vs Test 34's retention floor have no common solution | [detail](BACKLOG-DETAIL.md#bl-41) |
