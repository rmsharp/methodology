...
→ **[Tutorial 5: Cautionary Use](T5_cautionary.md)** — the gates, the 28 failure modes, "1 and done," the vertical-slice gates, and the Plan-Mode exit trap, built on the near-misses from *this* session — and when the methodology is too heavy to bother.
