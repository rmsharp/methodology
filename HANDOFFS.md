...
**Retention policy — this ledger keeps FOUR receipts.** This file currently holds **1**; everything
...
**Archived 6 record(s), 2026-09-15 → 2026-09-16** into [`docs/archive/HANDOFFS-through-2026-09-16.md`](docs/archive/HANDOFFS-through-2026-09-16.md) — same format, same order, frozen.
Losslessness is proved by [`docs/archive/HANDOFFS-through-2026-09-16.md.verify.sh`](docs/archive/HANDOFFS-through-2026-09-16.md.verify.sh), which re-derives L1/L2/L3 from git; run it rather
